...
export default function WizardShell({ site, completedStepsArray, initialConfig, initialLogoUrl, initialHeroUrl, initialFaviconUrl, userEmail, initialFirstSeries, initialFirstSermon, initialFirstMinistries, initialFirstEvent, initialFirstArticle, initialFirstStaff, initialFirstLeaders, initialMarqueePhotos, initialFirstBulletin, initialAboutProse, initialBeliefsProse, initialVisitProse, initialFaqItems }: WizardShellProps) {
  ...
  if (launched) {
    return <BuildProgressStep site={site} cfPagesUrl={launched.cfPagesUrl} />;
  }

  const visibleSteps = getVisibleSteps(completedSteps, enabledFeatures);

  function renderCurrentStep() {
    const base = { site, onComplete: () => handleComplete(currentStep) };
    ...
    switch (currentStep) {
      ...
      />;
      case "sermons": return <SermonFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("sermons") ? features.sermons : undefined} />;
      case "series": return <SeriesFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("series") ? features.series : undefined} />;
      case "ministries": return <MinistriesFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("ministries") ? features.ministries : undefined} />;
      case "events": return <EventsFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("events") ? features.events : undefined} />;
      case "articles": return <ArticlesFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("articles") ? features.articles : undefined} />;
      case "staff": return <StaffFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("staff") ? features.staff : undefined} />;
      case "bulletins": return <BulletinsFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("bulletins") ? features.bulletins : undefined} />;
      case "leadership": return <LeadershipFeatureStep site={site} onComplete={featureOnComplete} initialEnabled={completedSteps.has("leadership") ? features.leadership : undefined} />;
