...
export default function StaffStep({
  ...
  async function handlePhotoChange(
    ...
    setRows((prev) =>
      prev.map((r) =>
        r.id === id
          ? { ...r, photoPreview: preview, photoBase64: base64, photoExt: ext }
          : r,
      ),
    );
  }
      ...
      await saveStaffMembers(
        ...
        filled.map((r) => ({
          ...
          ...(r.proseContent.trim()
            ...
            : {}),
          ...(r.photoBase64
            ? { photoBase64: r.photoBase64, photoExt: r.photoExt ?? "jpg" }
            : {}),
        })),
      );
      onComplete();
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground text-sm">
          Introduce your team. Add names and photos to create your staff
          directory.
        </p>
      </div>
