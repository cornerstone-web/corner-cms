...
import { Trash2, Upload, FolderOpen, ArrowUpRight, Music } from "lucide-react";
...
const AudioTeaser = ({ file, config, onRemove }: {
  file: string;
  config: any;
  onRemove: () => void;
}) => {
...
const AudioEditComponent = forwardRef((props: any, ref: React.Ref<HTMLInputElement>) => {
      ...
      <MediaUpload.DropZone>
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Recommended: MP3 or M4A, under 100MB.
          </p>
        </div>
      </MediaUpload.DropZone>
    </MediaUpload>
